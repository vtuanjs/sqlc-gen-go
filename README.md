...
- name: golang
  wasm:
    url: https://github.com/vtuanjs/sqlc-gen-go/releases/download/v3.1.3/sqlc-gen-go.wasm
    sha256: 22e0314308d8d841d2754fb3b9cb0684a1ee6130f9516db26d84bb4888ec2806
sql:
- schema: schema.sql
  queries: query.sql
  engine: postgresql
